      ...
      <div>
        ...
        <div className="h-fit md:h-[30rem] py-[3rem] flex flex-col md:flex-row justify-around border-t">
          ...
          <div className="basis-[60%] flex flex-col justify-center md:mx-8">
            ...
            <p className="pt-8 hidden md:block">{orderItem.description}</p>
            <div className="flex  justify-between mt-4">
              <div className="flex gap-20">
                ...
                <div>
                  <p>Quantity: </p>
                  <p className="md:text-[2rem]">{orderItem.quantity}</p>
                </div>
              </div>
              <div>
                <p>Total price: </p>
                <p className="md:text-[2rem] text-colorTertiary">
                  {(orderItem.priceByOrder * orderItem.quantity).toFixed(2)}$
                </p>
              </div>
            </div>
            <p className="mt-auto pt-4">
              <Link to={`/product/${orderItem._id}`} className="underline">
                Details
              </Link>
            </p>
          </div>
