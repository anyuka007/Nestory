  ...
  return (
    <>
      <div className="mx-auto w-full aspect-[4/2] bg-colorPrimary rounded-3xl relative ">
        ...
        >
          <Button text="Shop Now" width="180px" height="46px" fontSize="18px" />
        </Link>
        <Link
        ...
        >
          <Button text="Shop Now" width="100px" height="34px" fontSize="12px" />
        </Link>
        ...
        {[
          ...
          <div
            ...
            onMouseEnter={() => handleMouseEnter(prices[index].price)}
