...
const ShoppingCart = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col gap-1 xl:flex-row px-0">
      {/* <div className=" left w-full py-14 px-6 xl:w-[80%]"> */}
      <div className="left lg:w-[130%] py-14 px-20 ">
      ...
      {cartItems.length > 0 && (
        <div className="bg-white xl:w-[60%] md:py-8 h-fit ml-10">
