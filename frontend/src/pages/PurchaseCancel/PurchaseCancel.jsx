        ...
        <div className="h-[60vh] flex items-center justify-center px-4 ">
            ...
            <div className="max-w-lg w-full bg-gray-100 rounded-lg shadow-xl overflow-hidden relative z-10">
                <div className=" p-6 sm:p-8">
                    ...
                    <div className="bg-colorPrimary rounded-lg p-4 mb-6">
                    ...
                    <div className="space-y-4">
                        <Link
                            to={"/"}
                            className="w-full bg-colorPrimary hover:bg-colorSecondary text-white font-bold py-2 px-4 rounded-lg transition duration-300 flex items-center justify-center"
                        >
