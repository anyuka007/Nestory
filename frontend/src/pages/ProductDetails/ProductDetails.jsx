...
const ProductDetails = () => {
  ...
  const addToCart = async () => {
    ...
    setTimeout(() => {
      ...
      const adjustedLeft = endRect.left - startRect.left - elementWidth / 4;
      const adjustedTop =
        endRect.top - startRect.top - elementHeight * 2.1 - window.scrollY;
          ...
          <div className="basis-[30%] flex flex-col justify-center space-y-10 ">
            ...
            <div className="parent flex justify-between items-center">
              <QuantitySelector
                ...
                increaseQuantity={() =>
                  handleQuantityChange(quantityProductDetails + 1)
                }
                decreaseQuantity={() =>
                  handleQuantityChange(Math.max(1, quantityProductDetails - 1))
                }
              />
